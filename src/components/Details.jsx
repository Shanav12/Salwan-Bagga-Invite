        ...
        <div className="">
            <section className="bg-[#dbeafe] border-t border-gold/12 py-12 px-6 text-center">
                ...
                <div className="flex items-center justify-center gap-4 mb-12">
                    <span className="h-px w-8 md:w-12 bg-[#8c6e2f]"></span>
                ...
                <p className="font-prata font-light text-[clamp(1rem,2.6vw,1rem)] mb-3 leading-[1.9] tracking-wide ">
                    Click the button below to visit the wedding website.
                </p>
                ...
                <div className="flex flex-col items-center gap-4 mb-5">
                    <button
                        ...
                        className="font-prata italic font-normal text-[clamp(0.8rem,2.4vw,0.8rem)] tracking-[0.2em] uppercase bg-[#8c6e2f] cursor-pointer text-white px-8 py-3 rounded-full hover:bg-[#b8973b] transition-colors shadow-sm"
                    >
